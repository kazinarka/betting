...
init:
	cd client; cargo run -- init -e dev -s /Users/illiafedotov/.config/solana/id.json -m 4mDt5VKSWJbk24HwFD5Na2pqB3WZj7bdrxPwCDT4BAcs -t Kg7atGGZGiznRLRfbCizcJvcZdSzjYURRJqwEdx5Xqe
...
set_type_price:
	cd client; cargo run -- set_type_price -e dev -s /Users/illiafedotov/.config/solana/id.json -t 1 -p 10

add_supported_token:
	cd client; cargo run -- add_supported_token -e dev -s /Users/illiafedotov/.config/solana/id.json -t 8hp71urEffeQFo49wSbe43rwAnj2Mw5sgCDWhWGTzYH1

registration:
	cd client; cargo run -- registration -e dev -s /Users/illiafedotov/.config/solana/user.json -r 6G7Sc3MjR4AZDAgNJZJmSpLuiNUCRksF3bN8opeX2Fuj -p password
